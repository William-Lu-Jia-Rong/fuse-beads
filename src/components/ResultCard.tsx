...
export function ResultCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 mt-8 w-full max-w-3xl mx-auto min-w-0">
        ...
        <div className="flex-1 min-w-0 w-full">
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <span className="text-2xl font-semibold text-gray-900">
                {data.grid.cols}{" "}
                <span className="text-sm font-normal text-gray-500">×</span> {data.grid.rows}
              </span>
            </div>
            <div className="flex flex-col min-w-0">
              <span className="text-xs text-gray-500 font-medium uppercase tracking-wider mb-1 break-words">
